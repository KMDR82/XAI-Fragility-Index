...
PRIMARY_CSV_PATH = '/kaggle/input/datasets/aakkaya/xfidahil/q1_full_experiment_results_with_xfi.csv'
FALLBACK_CSV_PATH = 'q1_full_experiment_results_with_xfi.csv'
OUTPUT_DIR = 'figures'
